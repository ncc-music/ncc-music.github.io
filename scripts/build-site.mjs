...
for (const name of ['index.html', 'styles.css', 'robots.txt', 'sitemap.xml', 'manifest.webmanifest', 'service-worker.js']) {
...
for (const name of ['gdrive-player.js', 'sets.js', 'content.js', 'detail-waveform.js', 'tracklist-search.js', 'waveform-stream.js', 'waveform-worker.js', 'visits.js', 'pwa.js']) {
