...
Cada ficha muestra nombre, fecha si está cargada, tracklist completo, controles/likes/compartir y waveform interactivo. Freaks Comments forma parte del bloque del waveform: el campo indica en vivo el momento del comentario, permite elegir otro punto desde la línea inferior con un botón `+` y acepta hasta 280 caracteres. Esa zona de comentarios no activa play/pausa. Las marcas temporales se muestran compactas y los comentarios cercanos se agrupan. El nombre del comentarista es opcional y usa `AnonymousFreak` por defecto. Cada navegador puede sumar o retirar una reacción 🔥 por set. El waveform normaliza y suaviza levemente los picos, muestra el tiempo al recorrerlo, anima la carga y conserva una parte principal con un reflejo inferior reducido. Sin BPM, estilo ni asociación entre pistas y tiempos. Las fichas y Tracklists comparten la misma información. El slug se conserva al editar.
...
- Now Playing muestra identidad, nombre y fecha, controles, tiempo, waveform, likes, compartir y tracklist completo. Ocupa el 95% de la altura visible en escritorio y toda la pantalla en celulares; Escape minimiza la vista.
- La waveform de la ficha y de Now Playing incluye un botón Play central. El botón desaparece durante la reproducción y nunca se interpreta como un salto al centro del audio. La imagen situada en una franja horizontal compacta sobre el waveform también alterna reproducción y pausa, y reproduce su animación cuando el audio está activo; en celulares su icono superpuesto permanece oculto y toda la imagen conserva la acción.
...
- En la lista de Sets, el botón de reproducción del set activo cambia a cuatro barras verticales de vúmetro animadas desde su base y en blanco y negro. Al pausar recupera el icono de play.
